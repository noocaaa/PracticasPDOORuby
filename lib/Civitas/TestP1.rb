...
=begin
  ...
  j1 = j2 = j3 = j4 = 0
  for i in 1..100 do
    valor = Dado.instance.quien_empieza(4)
    if valor == 0
      j1 += 1
    elsif valor == 1
      j2 += 1
...
=begin
  ...
  temp.aniade_casilla(uno)
  temp.aniade_casilla(dos)
  temp.aniade_casilla(tres)
  temp.aniade_casilla(q)
  temp.aniade_casilla(c)
  temp.aniade_casilla(s)
  temp.aniade_juez

  tirada = Dado.instance.tirar
  punto = 4
  destino = temp.nueva_posicion(punto, tirada)
  puts temp.p
  puts tirada
  puts destino
  puts temp.calcular_tirada(punto, destino)
